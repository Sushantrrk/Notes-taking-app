# importing all the required modules for the GUI and mysql
from tkinter import *
...
conn = connector.connect(host = "localhost", user = db_user, password = db_pass)
cur = conn.cursor()
...
edit_image = PhotoImage(file = "edit.png")
